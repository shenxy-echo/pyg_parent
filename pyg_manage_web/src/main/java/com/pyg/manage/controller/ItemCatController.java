...
public class ItemCatController {
	...
	public PageResult search(long id, int page, int rows  ){
		return itemCatService.findPage(id, page, rows);
	}

	@RequestMapping("/findByPid")
	public List<TbItemCat> getCatById(Long id){
		return itemCatService.getItemCatByPid(id);
	}
